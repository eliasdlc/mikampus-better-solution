...
> Se actualiza al cerrar cada fase. Última actualización: 18-jul-2026 (cierre Fase 9).

**En `dev`:** Fases 1–7 — la v2 completa más el tiempo (Fase 6) y el pénsum estructurado (Fase 7) de v3. **En rama `phase/8-trayectoria`, sin mergear:** Fases 8, 8.5 y 9. **Sigue:** Fase 10 (§12.7); el módulo de documentos (§12.6) arranca cuando llegue el pénsum oficial.
